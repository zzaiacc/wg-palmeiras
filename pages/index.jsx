      ...
      <div className="lg:mt-[20vh] xs:mt-[100px] lg:mb-10 max-w-[1320px] mx-auto">
        <div className="hidden xs:block lg:block">
          <div className="flex items-center">
            <div className="flex-grow border-t  xs:border-white md:border-green" />
            <div className="flex flex-col lg:mx-10">
              <h1 className="flex-shrink lg:px-10 text-green text-[80px] text-center xs:text-[50px] font-medium uppercase tracking-widest">
                Mantos da Glória
              </h1>
            </div>
            <div className="flex-grow border-t xs:border-white md:border-green" />
        ...
        <div className="lg:mt-[5vh] xs:mt-[10vh] items-center mb-10 flex justify-center">
