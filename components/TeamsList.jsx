    ...
    <div className="flex flex-col justify-center hover:scale-110 duration-500 ">
      <Link href={path}>
        <img
          src={logo}
          alt={name}
          className="lg:rounded-t-md lg:rounded-b-none sm:w-[30px] md:w-[100px] lg:w-[180px] sm:rounded-b-md"
        />
        <div
          className="justify-center rounded-b-md p-2 lg:w-[180px] hidden sm:block md:block "
